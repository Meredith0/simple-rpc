package rpc.zengfk.remoting.transport.netty.codec;

import io.netty.buffer.ByteBuf;
import io.netty.channel.ChannelHandlerContext;
import io.netty.handler.codec.MessageToByteEncoder;
import lombok.extern.slf4j.Slf4j;
import rpc.zengfk.enums.CompressorEnum;
import rpc.zengfk.enums.SerializerEnum;
import rpc.zengfk.extension.ExtensionLoader;
import rpc.zengfk.protocol.RpcProtocol;
import rpc.zengfk.remoting.compression.Compressor;
import rpc.zengfk.serialize.Serializer;
